...
[assembly: WebActivatorEx.PostApplicationStartMethod(typeof(One.App_Start.BootstrapBundleConfig), "RegisterBundles")]
...
namespace One.App_Start
{
	public class BootstrapBundleConfig
	{
		public static void RegisterBundles()
		{
            ...
            BundleTable.Bundles.Add(new ScriptBundle("~/bundles/mouse").Include("~/Scripts/mouse*"));
		}
	}
}
